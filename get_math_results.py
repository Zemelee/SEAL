...
from eval_math_rule.evaluation.parser import (
    extract_answer,
    parse_ground_truth,
    strip_string,
)
...
def main(res_path, save=False, k=None, output_dir=None):
    ...
    for example in tqdm(data):
        ...
        all_pred = [
            extract_answer(p, data_name="omni-math")
            for p in example["model_generation"]
        ]
        ...
        effective_pred = [
            p for p, o in zip(all_pred, example["model_generation"]) if "boxed" in o
        ]
